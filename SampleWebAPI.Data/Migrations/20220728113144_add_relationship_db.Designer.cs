...
namespace SampleWebAPI.Data.Migrations
{
    ...
    [Migration("20220728113144_add_relationship_db")]
    partial class add_relationship_db
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SampleWebAPI.Domain.TypeSword", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SampleWebAPI.Domain.TypeSword", b =>
                {
                    b.HasOne("SampleWebAPI.Domain.Sword", "Sword")
                        .WithOne("TypeSword")
                        .HasForeignKey("SampleWebAPI.Domain.TypeSword", "SwordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
